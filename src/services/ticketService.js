...
export class TicketService {
    ...
    try {
      ...
      const actionRow = new ActionRowBuilder()
        .addComponents(
          ...
          new ButtonBuilder().setCustomId('ticket_rename').setLabel('Rename Ticket').setStyle(ButtonStyle.Secondary)
        );
  ...
  async closeTicket(channel, closedBy) {
    try {
      ...
      await this.logTicket(channel.guild, 'CLOSED', { ticketNumber: ticketData.ticket_number, closedBy, channel });
